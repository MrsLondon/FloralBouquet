  ...
  return (
    <div className="min-h-screen p-6 bg-white-100">
      ...
      <ul className="flex justify-center gap-6 text-lg font-semibold mb-6">
        <li>
          <Link to="/peony?context=wedding" className="hover:text-orange-600">
            Peony
          </Link>
        </li>
        <li>
          <Link to="/lilies?context=wedding" className="hover:text-orange-600">
            Lilies
          </Link>
        </li>
        <li>
          <Link to="/roses?context=wedding" className="hover:text-orange-600">
            Roses
          </Link>
        </li>
        <li>
          <Link to="/tulips?context=wedding" className="hover:text-orange-600">
            Tulips
          </Link>
        </li>
      </ul>
