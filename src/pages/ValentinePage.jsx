  ...
  return (
    <div className="min-h-screen p-6 bg-white-100">
      ...
      <ul className="flex justify-center gap-6 text-lg font-semibold mb-6">
        <li>
          <Link to="/lilies?context=valentine" className="hover:text-orange-600">
            Lilies
          </Link>
        </li>
        <li>
          <Link to="/roses?context=valentine" className="hover:text-orange-600">
            Roses
          </Link>
        </li>
        <li>
          <Link to="/tulips?context=valentine" className="hover:text-orange-600">
            Tulips
          </Link>
        </li>
      </ul>
